...
public class DriverScript {
	...
	public static String sTestSummary;
	...
	public void DriverScriptS() throws NoSuchMethodException, SecurityException, IOException{
		 ...
		 reporter.loadXMLConfig(new File("/home/mohan/gitFramework/RentlyTestAutomation/extent-config.xml"));
    ...
    private void execute_TestCase() throws Exception {
        ...
        //F6 F5 F8
            ...
            for(int iTestcase=1;iTestcase<iTotalTestCases;iTestcase++){
				...
				sTestSummary=ExcelUtils.getCellData(iTestcase, Constants.Col_Summary, Constants.Sheet_TestCases);
				...
				if (sRunMode.equals("Yes")){
					 test = report.createTest(sTestCaseID,sTestSummary);
		...
		for(int i=0;i<method.length;i++){
			...
			if(method[i].getName().equals(sActionKeyword)){
				...
				if(bResult==true){
					...
					//test.addScreenCaptureFromPath(capture(actionKeywords.driver));
					if(!(sActionKeyword.contentEquals("quitedriver")))
					test.pass(TestStepDescription,MediaEntityBuilder.createScreenCaptureFromPath(capture(actionKeywords.driver)).build());
					else
...
//					if(sActionKeyword.contentEquals("quitedriver"))
						test.fail(TestStepDescription,MediaEntityBuilder.createScreenCaptureFromPath(capture(actionKeywords.driver)).build());
//						else
//							test.fail(TestStepDescription);
	...
	public void quit() {
	   ...
	   public static String capture(WebDriver driver) throws IOException {
	    	 ...
	    	 Date date=new Date();
	    	 File Dest = new File("/Screenshot/" + sActionKeyword+" "+date
	    	 + ".png");
